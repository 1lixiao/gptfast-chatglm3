...
def main(
    ...
    if is_prefill_cache:
        ...
        prefill_cache = None
    if prefill_cache is not None:
        prefill_cache.set_context(PrefillCacheContext(prompt["prompt"], prompt_length, model))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=Path, default=Path(
        "../ChatGLM-Finetuning-master/output/output-glm3_34caps_mixed_data_8_4096/epoch-10-step-1320/chatglm3.pth"),
